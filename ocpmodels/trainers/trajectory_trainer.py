...
from ocpmodels.common.data_parallel import SystemParallelCollater
from ocpmodels.common.registry import registry
from ocpmodels.common.relaxation.ml_relaxation import ml_relax
from ocpmodels.common.utils import plot_histogram
from ocpmodels.modules.evaluator import Evaluator, average_distance, energy_mae
from ocpmodels.modules.normalizer import Normalizer
from ocpmodels.trainers.base_trainer import BaseTrainer


@registry.register_trainer("trajectory")
class TrajectoryTrainer(BaseTrainer):
    """
    ...
    def load_task(self):
        ...
        self.parallel_collater = SystemParallelCollater(
        ...
        for epoch in range(self.config["optim"]["max_epochs"]):
            ...
            for i, batch in enumerate(self.train_loader):
                ...
                if epoch >= self.config["optim"]["warmup_epochs"]:
                    ...
                    loss += (
                        self.config["optim"]["is2rs_coefficient"] * is2rs_loss
                        + self.config["optim"]["is2re_coefficient"]
                        * is2re_loss
                    )
    ...
    def _run_train_relaxations(self, batch):
        ...
        is2rs_loss = np.mean(average_distance(prediction, target))
        is2re_loss = energy_mae(prediction, target)["metric"]
        return relaxed_batch, is2rs_loss, is2re_loss
