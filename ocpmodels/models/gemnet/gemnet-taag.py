...
from ocpmodels.models.gemnet.layers.efficient import (
    EfficientInteractionDownProjection,
)
from ocpmodels.models.gemnet.layers.embedding_block import (
    AtomEmbedding,
    EdgeEmbedding,
)
...
from ocpmodels.models.gemnet.layers.scaling import AutomaticFit, ScalingFactor
...
class GemNetT(torch.nn.Module):
    ...
    def generate_interaction_graph(self, data):
        ...
        if self.use_pbc:
            ...
            j, i = edge_index
            D_st = (data.pos[j] - data.pos[i]).pow(2).sum(dim=-1).sqrt()
