...
class EquiformerV2S_OC20(BaseModel):
    ...
    Args:
        ...
        norm_scale_nodes (float):   Normalization factor for sum aggregation over nodes
        norm_scale_degree (float):  Normalization factor for sum aggregation over edges
    """
    def __init__(
        self,
        num_atoms,      # not used
        ...
        self.norm_scale_nodes = norm_scale_nodes
        self.norm_scale_degree = norm_scale_degree
        ...
        self.edge_degree_embedding = EdgeDegreeEmbedding(
            ...
            rescale_factor=self.norm_scale_degree
        )
    ...
    def forward(self, data):
        ...
        energy = energy / self.norm_scale_nodes
