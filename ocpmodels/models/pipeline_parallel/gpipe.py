...
def recommend_auto_balance(message: str) -> str:
    """Expands a message with recommendation to :mod:`.balance`."""
    return f"""{message}

If your model is still under development, its optimal balance would change
frequently. In this case, we highly recommend '.balance' for naive
automatic balancing:

  from  import GPipe
  from .balance import balance_by_time
...
class GPipe(Module):
    ...
    def forward(self, input: Any) -> TensorOrTensors:  # type: ignore
