...
For convenience, a self-contained script can be found [here](https://github.com/FAIR-Chenm/fairchem/blob/main/src/fairchem/core/scripts/download_data.py) to download, preprocess, and organize the data directories to be readily usable by the existing [configs](https://github.com/Open-Catalyst-Project/ocp/tree/main/src/fairchem/configs).
