...
First we get the checkpoint that we want. According to the [MODELS](../../../catalysts/models) the GemNet-OC OC20+OC22 combination has an energy MAE of 0.483 which seems like a good place to start. This model was trained on oxides.
