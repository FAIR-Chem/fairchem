...
FAIRChem provides several [models](../core/intro). Each model represents a different approach to featurization, and a different machine learning architecture. The models can be used for different tasks, and you will find different checkpoints associated with different datasets and tasks. 

[TODO] Discussion about GNNs and various model types
