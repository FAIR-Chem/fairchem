:py:mod:`data.oc.tests.old_tests.check_inputs`
==============================================

.. py:module:: data.oc.tests.old_tests.check_inputs
...
.. autoapisummary::
   ...
   data.oc.tests.old_tests.check_inputs.obtain_metadata
   data.oc.tests.old_tests.check_inputs.create_df
   data.oc.tests.old_tests.check_inputs.adslabs_are_unique
   data.oc.tests.old_tests.check_inputs.check_commonelems
   data.oc.tests.old_tests.check_inputs.is_adsorbate_placed_correct
   data.oc.tests.old_tests.check_inputs._get_connectivity
