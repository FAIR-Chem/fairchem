:py:mod:`fairchem.demo.ocpapi.client`
=====================================

.. py:module:: fairchem.demo.ocpapi.client
...
.. autoapisummary::
   ...
   fairchem.demo.ocpapi.client.Adsorbates
   fairchem.demo.ocpapi.client.AdsorbateSlabConfigs
   fairchem.demo.ocpapi.client.AdsorbateSlabRelaxationResult
   fairchem.demo.ocpapi.client.AdsorbateSlabRelaxationsRequest
   fairchem.demo.ocpapi.client.AdsorbateSlabRelaxationsResults
   fairchem.demo.ocpapi.client.AdsorbateSlabRelaxationsSystem
   fairchem.demo.ocpapi.client.Atoms
   fairchem.demo.ocpapi.client.Bulk
   fairchem.demo.ocpapi.client.Bulks
   fairchem.demo.ocpapi.client.Model
   fairchem.demo.ocpapi.client.Models
   fairchem.demo.ocpapi.client.Slab
   fairchem.demo.ocpapi.client.SlabMetadata
   fairchem.demo.ocpapi.client.Slabs
   fairchem.demo.ocpapi.client.Status
...
.. autoapisummary::
   ...
   fairchem.demo.ocpapi.client.get_results_ui_url
