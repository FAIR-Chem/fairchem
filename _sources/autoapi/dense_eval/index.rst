...
.. autoapisummary::
   ...
   dense_eval.is_successful
   dense_eval.compute_hybrid_success
   dense_eval.compute_valid_ml_success
   dense_eval.get_dft_data
   dense_eval.get_dft_compute
   dense_eval.filter_ml_data
