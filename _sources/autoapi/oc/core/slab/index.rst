...
.. autoapisummary::
   ...
   oc.core.slab.tile_and_tag_atoms
   oc.core.slab.set_fixed_atom_constraints
   oc.core.slab.tag_surface_atoms
   oc.core.slab.tile_atoms
   oc.core.slab.find_surface_atoms_by_height
   oc.core.slab.find_surface_atoms_with_voronoi_given_height
   oc.core.slab.calculate_center_of_mass
   oc.core.slab.calculate_coordination_of_bulk_atoms
   oc.core.slab.compute_slabs
   oc.core.slab.flip_struct
   oc.core.slab.is_structure_invertible
   oc.core.slab.standardize_bulk
