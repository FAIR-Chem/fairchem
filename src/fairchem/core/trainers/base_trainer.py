...
from fairchem.core.datasets.base_dataset import ConcatDataset, create_dataset
...
class BaseTrainer(ABC):
    ...
    def load_datasets(self) -> None:
        ...
        if self.config["dataset"].get("datasets", None):
            ...
            self.train_dataset = ConcatDataset([
                create_dataset(
                    convert_settings_to_split_settings(config, "train"),
                    "train",
                ) for config in self.config["dataset"]["datasets"]
            ])
            ...
            if self.config.get("val_dataset", None):
                ...
                self.val_dataset = ConcatDataset([
                    create_dataset(
                        convert_settings_to_split_settings(config, "val"),
                        "val",
            ...
            if self.config.get("test_dataset", None):
                ...
                self.test_dataset = ConcatDataset([
                    create_dataset(
                        convert_settings_to_split_settings(config, "test"),
                        "test",
