        ...
        for adsorbate in all_adsorbates:
            ...
            for run in runs:
                ...
                for fair_name in specific_names:
                    ...
                    full_traj = ase.io.read(current_dir+f"/{fair_name}_{adsorbate}_full.traj", ":")
                    for idx, image in enumerate(full_traj):
                        for idx_var, var in enumerate([.005, 0.01, 0.05, 0.1, 0.5]):
                            ...
                            ase.io.write(os.path.join(to_dir, "POSCAR"), rattled_image, format='vasp')
