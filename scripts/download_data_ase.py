...
def get_data(datadir, task, split, del_intmd_files, ref_energy):
...
def uncompress_data(compressed_dir):
    ...
    args.opdir = os.path.dirname(compressed_dir) + "_total_energy"
    uncompress.main(args)
    return args.opdir


def preprocess_data(uncompressed_dir, output_path):
    import preprocess_ef_ase as preprocess
