...
if __name__ == "__main__":
    ...
    singles = [
        ...
        "--config=faenet-s2ef-200k --regress_forces=from_energy",
        "--config=forcenet-s2ef-200k --regress_forces=direct",
        "--config=sfarinet-s2ef-200k --regress_forces=direct",
        "--config=faenet-s2ef-200k --regress_forces=direct",
        ...
        "--config=faenet-s2ef-200k --regress_forces=direct_with_gradient_target",
